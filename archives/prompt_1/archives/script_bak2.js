...
function generateCodePrompt() {
  ...
  <contexte_projet>
    ...
    ${role ? `<role_developeur>${role}</role_developeur>` : ""}
  </contexte_projet>
...
<persona_expert>
Tu es un expert en prompt engineering pour développement logiciel avec 8+ ans d'expérience. Tu maîtrises tous les langages, frameworks, architectures, et best practices de développement.
</persona_expert>
...
<persona_expert>
Tu es un Architecte Logiciel Senior avec 10+ ans d'expérience en développement full-stack. Tu maîtrises parfaitement les frameworks modernes, l'architecture logicielle, UI/UX design et DevOps.
</persona_expert>
...
\`\`\`
### 📊 Évaluation :
- Clarté architecture : [X]/25
- Complétude features : [X]/25
- Qualité production : [X]/25
- Livrables : [X]/25
**TOTAL : [X]/100**

## 🏆 PROMPT FINAL - SCORE : [X]/100
\`\`\`
[Prompt application optimal]
\`\`\`
</format_reponse_strict>
